...
Visible foreign buildings: ${visibleForeignBuildings.map((building) => `${building.tribeId} ${building.type} at ${building.x},${building.y}`).join("; ") || "none currently visible"}
