...
5. **Fortification and item stat contract:** any future board item, siege engine, inventory object, projectile, dropped packet, or resource-processing installation must declare health, armor, attack, range, cooldown, browser-hook coverage, and destruction behavior when it can be targeted or can affect combat.
