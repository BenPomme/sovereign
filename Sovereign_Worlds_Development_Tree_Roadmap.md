...
1. **Development-tree expansion:** grow the implemented catalog from the current 16 functional nodes toward the planned 100+ civic, economic, cultural, military, media, law, labor, diplomacy, and infrastructure developments. Each node must keep the same rule: expose mechanics and consequences, not scripted strategy.
