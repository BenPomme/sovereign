...
3. **Advanced siege behavior:** add siege tools, wall/gate damage states, breach previews, contested field repairs under fire, and multi-unit assault doctrines on top of explicit building-target attacks.
